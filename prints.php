...
foreach ($_POST['ck'] as $k => $v) {
    ...
    foreach ($items as $k => $v) {
        ...
        $price += pPriceByIId($items[$k]['id']) * $items[$k]['quantity'];
    ...
    $html = '<body dir="rtl" style="font-family: XBRiyaz">
        <div style="text-align:left">' . $order['id'] . '<br>' . $order['odate'] . '</div>
        <div>
...
$pdfnam = min($_POST['ck']) . '-' . max($_POST['ck']) . '.pdf';
